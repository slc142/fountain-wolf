...
- Pieces cannot be stacked to more than 2 pieces high.
- Pieces visually float in the air if the player drags them outside the grid borders and attempts to place them (but they don't actually belong in the grid at the spot where they are visually placed).
